...
def compile_blog_scss():
    """
    Compiles the _blog.scss file into blog.css.
    """
    scss_file_path = os.path.join(os.path.dirname(__file__), 'css', '_blog.scss')
    css_file_path = os.path.join(os.path.dirname(__file__), 'css', 'blog.css')
